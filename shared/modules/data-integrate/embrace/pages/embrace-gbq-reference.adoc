...
+
image::/images/gbq-serviceaccount.png[Click on Service accounts]

. Click *+ CREATE SERVICE ACCOUNT* from the top menu.
. Specify a name, and add an optional description.
. Click *Create*.
+
image::/images/gcp-createserviceaccount.png[Create your service account]

. Specify permissions.
Under *Select a role*, choose menu:BigQuery[BigQuery Data Viewer].
+
image::/images/gbq-serviceaccountpermissions.png[Specify permissions]
