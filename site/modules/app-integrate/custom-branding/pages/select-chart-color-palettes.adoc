...
If the Style Customization option is not available, xref:/appliance/contact.adoc[Contact ThoughtSpot Support] to enable it.
. Navigate to the *Chart Color Palettes* section at the bottom of the *Style Customization* page.
+
image::/images/style-chartcolorpalettes.png[]
...
+
image::/images/stylecustomization-primary-color.png[Change the primary color palette]
+
...
You can also add a HEX color number directly.
+
image::/images/stylecustomization-secondary-color.png[Change the secondary color palette]
+
