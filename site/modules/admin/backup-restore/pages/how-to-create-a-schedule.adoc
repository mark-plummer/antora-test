...
There are slight differences between the configuration of snapshots and backups.
  Refer to xref:/admin/backup-restore/overview-snapshot.adoc[work with snapshots] and xref:/admin/backup-restore/configure-backup.adoc[configure periodic backups].
