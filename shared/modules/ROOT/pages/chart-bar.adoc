...
image::shared::charts-bar.png[Bar chart]
...
image::shared::charts-stacked-bar-labels.png[Stacked bar chart with labels]
...
image::shared::charts-stacked-bar-100.png[Stacked bar chart -- Stack 100 percent toggled on]
