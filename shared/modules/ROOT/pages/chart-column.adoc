...
image::shared:enterprise:charts-column.png[Column chart example]
...
image::shared:enterprise:charts-stackedcolumn-labels.png[Stacked column chart with labels]
...
image::shared:enterprise:charts-stackedcolumn-100.png[Stacked column chart example -- Stack 100 percent toggled on]
