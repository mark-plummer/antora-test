...
If the worksheet already exists in another cluster, you can migrate it link:{{ site.baseurl }}/admin/worksheets/worksheet-export.html#worksheet-migrate[using a flat `yaml` file].
