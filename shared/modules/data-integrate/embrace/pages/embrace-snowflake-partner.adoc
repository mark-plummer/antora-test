...
* Read the xref:/data-integrate/embrace/embrace-snowflake-best.adoc[best practices for Embrace with Snowflake].
...
* xref:/data-integrate/embrace/embrace-snowflake-tutorial.adoc[ThoughtSpot Tutorials for Snowflake Partner Connect]
