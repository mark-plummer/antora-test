...
{% include content/flexible-aggregation-best-practices.adoc %}
...
{% include content/intro-valid-solution.adoc %}
...
image::/images/supplier-tender-job-1.png[Supplier tendering by job, aggregated result]
...
{% include content/intro-non-aggregated.adoc %}
...
image::/images/supplier-tender-job-2.png[Supplier tendering by job, non-aggregated result]
...
image::/images/average-rate-exchange-1.png[Average rates of exchange, aggregated result]
...
image::/images/average-rate-exchange-2.png[Average rates of exchange, non-aggregated result]
...
image::/images/avg-period-non-additive-1-1.png[Average period value semi-additive numbers, aggregated result]
