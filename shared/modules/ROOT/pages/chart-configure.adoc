...
image::shared::edit-chart-configuration.png[Edit chart configuration]

// image::shared::configure_chart_icons.png [Configure chart icons]
...
image::shared::chartconfig-customize.png[Customize chart configuration]
