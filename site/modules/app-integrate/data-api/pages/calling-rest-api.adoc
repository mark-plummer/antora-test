...
image::/images/parsed_json_data.png[]
...
image::/images/columnnames_and_data_arrays.png[]

The REST API supports filtering the data returned through parameters that you pass within the URL.
These are called xref:/app-integrate/runtime-filters/about-runtime-filters.adoc[Runtime Filters].
