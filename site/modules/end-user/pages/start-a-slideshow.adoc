...
. In the open pinboard, click the *More Options* menu image:/images/icon-ellipses.png[more options menu icon] (ellipses icon), and select *image:/images/icon-present.png[present icon] Present*.
+
image::/images/pinboard-present.png[]
...
+
image::/images/pinboard-present-fullscreen.png[]
