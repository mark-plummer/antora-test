...
Users with R script privileges can click the *R* icon image:/images/r-icon-inline.png[R icon] on the toolbar for any search result (answer).
...
image::/images/r-load-or-write-script.png[]
...
For more on how to run provided scripts, skip to xref:/end-user/r-scripts/run-prebuilt-r-scripts.adoc[Run pre-built R scripts on answers]
...
Start with the topic on how to xref:/end-user/r-scripts/create-r-scripts.adoc[Create and share R scripts] to learn more about writing R scripts in ThoughtSpot, including a few particulars on syntax and column bindings.
...
image::/images/r-pinboard-examples.png[]

== Related information

* xref:create-r-scripts.adoc[Create and share R scripts]
* xref:run-prebuilt-r-scripts.adoc[Run pre-built R scripts on answers]
* xref:/spotiq/adv-customize-withr.adoc[SpotIQ custom analysis]
* xref:/admin/users-groups/about-users-groups.adoc[Understand groups and privileges]
* xref:/reference/tscli-command-ref.adoc#rpackage[tscli rpackage]
