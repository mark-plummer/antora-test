...
image::shared:enterprise:pivot_table_rows_measures_columns.png[]
...
image::shared:enterprise:pivot-context-menu.png[]
...
image::shared:enterprise:pivot_table_expand_collapse_all.png[]
...
image::shared:enterprise:pivot-grand-total.png[]
...
image::shared:enterprise:pivot-summaries.png[]
...
image::shared:enterprise:pivot-table-agg-totals.png[]
...
image::shared:enterprise:pivot_table_heatmap_mode.png[]
