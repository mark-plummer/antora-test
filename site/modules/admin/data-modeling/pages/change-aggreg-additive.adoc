...
image::/images/model_additive_model_false_options.png[]
...
image::/images/model_additive_model_true_options.png[]
...
xref:/admin/data-modeling/about-data-modeling-intro.doc[Model the data for searching]
