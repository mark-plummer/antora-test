...
+
image::/images/admin_icon.png[]

. Click *Data Management*, then click *Business Data Model*.
. Click *Download*.
+
image::/images/download_model.png[]
...
* link:data-modeling-settings.adoc[Data modeling settings]
* link:model-data-in-UI.adoc[Change a table's data model]
