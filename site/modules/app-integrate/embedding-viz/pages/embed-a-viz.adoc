...
+
If the object is a pinboard, click the ellipses icon image:/images/icon-ellipses.png[more options menu icon] >  *Copy Link*.
+
image::/images/embed-link-1.png[]
+
The format for the link is:  `<protocol>:<host>:<port>/#/embed/viz/<pinboardID>`
+
For a vizualization in a pinboard, click the ellipses icon image:/images/icon-ellipses.png[more options menu icon] >  *Copy Link*.
+
image::/images/embed-link-2.png[]
+
...
Contact mailto:support@thoughtspot.com[support@thoughtspot.com] for more help.
