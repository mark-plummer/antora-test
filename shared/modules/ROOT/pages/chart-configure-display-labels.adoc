...
+
image::shared::chartconfig-labels-all.png[Check the all labels box]
+
...
+
image::shared::chartconfig-reordervalues.png[Select a measure]

. Check the *data labels* box.
+  Note that only the *total sales* data has labels.
+
image::shared::chartconfig-datalabels.png[Check the data labels box]
...
+
image::shared::chartconfig-labelcategory.png[Specify a label category]
...
+
image::shared::chartconfig-decimals.png[Decimal specifications]
