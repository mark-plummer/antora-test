...
image:/images/gettingstarted-help-menu.png[The help dropdown menu]
...
image:/images/gettingstarted-helpbox.png[The customizable help menu]
...
image:/images/gettingstarted-helpmenu-additem.png[Add custom menu item]
...
image:/images/gettingstarted-helpcustomize.png[Customize help]
