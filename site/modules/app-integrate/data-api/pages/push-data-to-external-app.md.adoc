...
last_updated: 11/18/2019 summary: "This procedure shows how to use the Data Push API to send data from ThoughtSpot to another application." sidebar: mydoc_sidebar permalink: /:collection/:path.html -- The Data Push API allows you to open a web page in the context of the ThoughtSpot application.
