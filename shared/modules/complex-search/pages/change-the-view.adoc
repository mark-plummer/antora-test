...
+
image::/images/changeview-chartortable.png[Select table or chart]

When you display your data as a chart, ThoughtSpot automatically selects the type of chart that works best for your data.
If you want to use another type, click the change visualization icon image:/images/icon-chart-type-10px.png[] and select the type of chart you want.
Refer to xref:/end-user/search/about-charts.adoc[understand charts].
...
To bucket your data in a table view, click the ellipsis icon image:/images/icon-more-10px.png[] that appears when you hover over a column name on a table.
...
image::/images/changeview-bucket.png[Choose a date bucket on a table]

To bucket your data in a chart view, click the dropdown icon image:/images/icon-dropdown-down-10px.png[] that appears when you hover near the axis labels on a chart.

image::/images/changeview-chartbucket.png[Choose a date bucket on a chart]
...
+
image::/images/changeview-exclude.png[Exclude or include a value]
