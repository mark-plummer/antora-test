...
NOTE: Sharding and loading tables into ThoughtSpot only apply to ThoughtSpot's in-memory database.
If you use xref:/data-integrate/embrace/embrace-intro.html[Embrace], and store your data in another data warehouse such as Snowflake or Amazon Redshift, your data modeling is done in that data warehouse, and not in ThoughtSpot.
...
+
image::/images/sharding-skew.png[Skew example]
+
