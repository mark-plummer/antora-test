...
. Click *edit*.
+
image::shared::chartconfig-edityaxis.png[Click edit]
...
image::shared::chart-config-axis-range.gif[Change the axis range gif]
...
image::shared::chart-config-y-axis.gif[Change the axis range gif]
