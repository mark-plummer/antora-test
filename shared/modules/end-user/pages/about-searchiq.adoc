...
Find more information about what SearchIQ collects at xref:/end-user/search/searchiq-data-collection.adoc[SearchIQ data collection].

SearchIQ is a different search experience that understands more natural, speech-like search language than the xref:/end-user/search/about-starting-a-new-search.adoc[original ThoughtSpot search].
...
For more details, see xref:/end-user/search/searchiq-data-collection.adoc[SearchIQ data collection].
...
image::/images/choose_searchiq.png[]
...
If you leave the *SearchIQ* setting in the off position, you have the xref:/end-user/search/about-starting-a-new-search.adoc[original ThoughtSpot search experience], which uses keywords, column names, and data values.
...
* One of the special xref:/reference/keywords.adoc[keywords] ThoughtSpot understands: like yesterday, >, or contains
...
If you find that your natural language search doesn't return the results you expect, you can xref:/end-user/search/teach-searchiq.adoc[teach SearchIQ your language] easily.
...
* xref:/end-user/search/searchiq-data-collection.adoc[SearchIQ Data Collection]
