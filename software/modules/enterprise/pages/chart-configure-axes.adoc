...
image::shared::edit-axis.gif[Change axis]
...
image::shared::edit-axis-aggregate.png[Change axis aggregate]
...
+
image::shared::edit-axis-filter.png[Change axis filter]

. In the window modal, click *+ add a condition*.
+
image::shared::edit-axis-filter-1.png[Add a condition to axis]
...
+
image::shared::edit-axis-filter-2.png[Set filter comparison operation]
...
+
image::shared::edit-axis-filter-4.png[Add another filter condition]

. To remove a filter condition, click the delete icon (*x*) next to its definition.
+
image::shared::edit-axis-filter-5.png[Remove filter condition]

. Click *Done*.
+
image::shared::edit-axis-filter-6.png[Complete filter on axis]
...
image::shared::edit-axis-filter-applied.png[Chart with filter applied]

To remove a filter from the chart, click the *x* icon on the filter tile.

image::shared::edit-axis-filter-remove.png[Remove filter from a chart]
...
+
image::shared::edit-axis-conditional-formatting.png[Add conditional formatting]

. The *Conditional formatting* window modal appears.
+
image::shared::edit-axis-conditional-formatting-1.png[Conditional formatting interface]

. In the window modal, click *+ add formatting*.
+
image::shared::edit-axis-conditional-formatting-2.png[Add a format]
...
+
image::shared::edit-axis-conditional-formatting-3.png[Add conditional format range]
...
+
image::shared::edit-axis-conditional-formatting-4.png[Change conditional format color]
+
Alternatively, you can place a range band on the chart.
Select the *Fill chart* option.
+
image::shared::edit-axis-conditional-formatting-8.png[Add conditional format band]

. To add another condition, click *+add formatting*.
+
image::shared::edit-axis-conditional-formatting-5.png[Add another conditional format]

. To remove a defined conditional format, click the delete icon (*x*) next to its definition.
+
image::shared::edit-axis-conditional-formatting-6.png[Remove conditional format]

. Click *Done*.
+
image::shared::edit-axis-conditional-formatting-7.png[Complete conditional format]
...
image::shared::edit-axis-conditional-formatting-applied-comparison.png[Conditional formatting applied, two options]
...
image::shared::edit-axis-sort.png[Change axis sort]
...
image::shared::edit-axis-sort-applied.png[Compare unsorted chart and chart sorted in Descending order]
...
image::shared::edit-axis-position.png[Change axis position]
...
image::shared::edit-axis-position-applied.png[Compare charts with different position assignments]
...
image::shared::edit-axis-group.png[Group two axes]
...
image::shared::edit-axis-group-applied.png[Compare ungrouped chart and chart that groups similar measures]

Notice that the *Customize* menu shows a linkage between the two grouped axes.

image::shared::edit-axis-group-menu.png[Grouped axes]
...
image::shared::edit-axis-rename.png[Rename axis]
...
image::shared::edit-axis-options.gif[Edit the axis]
...
image::shared::remove-axis.gif[Remove the axis]
