...
+ If you do not have a private key, contact xref:/appliance/contact.adoc[ThoughtSpot Support] by email or through the support portal.
...
Next, xref:/appliance/azure/azure-cluster-install.adoc[install your ThoughtSpot clusters].
