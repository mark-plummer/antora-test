...
:last_updated: tbd 
:summary: "Use rule-based RLS to restrict a group's access to data.Users see only accessible row data." :sidebar: mydoc_sidebar permalink: /:collection/:path.html -- 
