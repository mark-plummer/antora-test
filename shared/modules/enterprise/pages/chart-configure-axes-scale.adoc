...
. While viewing your answer as a chart, click the dropdown menu icon image:/images/icon-caret-right-20px.png[] next to the y-axis label you want to change.
. Click *edit*.
+
image::shared:enterprise:chartconfig-edityaxis.png[Click edit]
...
image::shared:enterprise:chart-config-axis-range.gif[Change the axis range gif]
...
. Click the *edit* button image:/images/icon-edit-20px.png[] that appears when you hover over *y-axis*.
...
image::shared:enterprise:chart-config-y-axis.gif[Change the axis range gif]
...
* xref:/end-user/search/drag-and-drop.adoc[Customize columns for the X and Y axes]
* xref:/end-user/search/about-charts.adoc#charts-with-multiple-measures-on-the-y-axis[Charts with multiple measures on the y-axis]
