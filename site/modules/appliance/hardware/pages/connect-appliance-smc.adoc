...
If necessary, review the xref:/appliance/hardware/inthebox.adoc[Hardware Appliance Overview].
...
image:/images/smc-haswell-location-ports-new.png[Haswell port location]
...
image:/images/smc-appliance-skylake-location-ports.png[Skylake port location]
...
+ See xref:/appliance/hardware/connect-appliance-smc.adoc#haswell-port-location[Haswell port location] and xref:/appliance/hardware/connect-appliance-smc.adoc#skylake-port-location[Skylake port location].

[#appliance-step-3]
== Step 3: Turn on nodes

Turn on the power to the nodes by pressing the power button;
see xref:/appliance/hardware/connect-appliance-smc.adoc#smc-appliance-power-button[Appliance Power Button].
...
| image:/images/smc-haswell-power-button-new.png[The power button is at the front of the Haswell appliance.]
| &#32;
| image:/images/smc-appliance-skylake-power-button.png[The power button is at the front of the Skylake appliance]
|===
...
Next, xref:/appliance/hardware/configure-nodes-smc.adoc[configure nodes.]
