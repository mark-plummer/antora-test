...
With SpotIQ analysis and insight feedback, you can rate an insight by clicking the like image:/images/thumb_up.png[more options menu icon] or dislike image:/images/thumb_down.png[more options menu icon] icon of the insight.
...
image::/images/insight-feedback-simple.png[]

////
The following are examples of questions based on different types of insights.

*Anomaly insight:* <br>
image::/images/anomaly_insight.png[]

*Trend insight:* <br>
image::/images/trend_insight.png[]

*Cross-correlation insight:* <br>
image::/images/cross_corr_insight.png[]
...
image::/images/insight-feedback.png[]
...
image::/images/feedback-delete.png[]
