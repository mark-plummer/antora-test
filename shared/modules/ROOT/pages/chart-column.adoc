...
image::shared::charts-column.png[Column chart example]
...
image::shared::charts-stackedcolumn-labels.png[Stacked column chart with labels]
...
image::shared::charts-stackedcolumn-100.png[Stacked column chart example -- Stack 100 percent toggled on]
