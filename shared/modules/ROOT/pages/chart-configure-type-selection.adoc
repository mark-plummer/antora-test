...
. Click the *change visualization* icon image:/images/icon-chart-type-10px.png[] at the top right to open the *chart catalog*.
. In the bottom right corner of the *Chart* menu, turn off *automatically select my chart*.
+
image::shared:enterprise:chart-config-autoselect.png[Turn off auto-selection of chart type]
