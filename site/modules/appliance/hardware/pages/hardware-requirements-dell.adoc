...
image:/images/dell-front-view.png[Dell front view]
...
image:/images/dell-back-view.png[Dell back view]
...
image:/images/dell-servicetab.png[Serial number location]
...
image:/images/dell-servicetag-open.png[View your service tag]
...
Next, xref:/appliance/hardware/connect-appliance-dell.adoc[connect the appliance.]
