...
image::/images/chart-config-text.gif[Wrap or clip long text]
...
image::/images/chartconfig-headlines.png[]
...
image::/images/pin_headline.png[Add a headline to a pinboard]

You can decide whether or not to display headlines in your table results.
To  customize headlines, click the ellipsis icon image:/images/icon-more-10px.png[] and select *Customize Summaries*.
...
image::/images/table-aggregate.png[Table aggregate headline]
