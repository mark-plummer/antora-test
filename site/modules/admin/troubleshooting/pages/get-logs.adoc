...
Detailed syntax and options are listed in the xref:/reference/tscli-command-ref.adoc#[tscli command reference].
...
See xref:/admin/troubleshooting/upload-logs-egnyte.adoc[Upload logs to ThoughtSpot Support] about using a secure file sever to collect log files or other files needed for troubleshooting.
