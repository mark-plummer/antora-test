...
* Using date formulas with the `fiscal` option specified. See xref:/advanced-search/formulas/date-formulas.adoc#fiscal-and-gregorian-calendars[Fiscal and Gregorian calendars].
...
To enable the custom calendar feature for your cluster, contact https://docs.thoughtspot.com/latest/admin/misc/contact.html[ThoughSpot support].
...
+
Example calendar with the fiscal year beginning on April 1:  image:/images/custom_cal.png[]
...
To set your custom calendar as the default calendar for your cluster, contact https://docs.thoughtspot.com/latest/admin/misc/contact.html[ThoughtSpot Support].
