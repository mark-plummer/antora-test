...
+
image::/images/spotiq-in-sights.png[]
+
The first panel provides information about the analysis.

. Click the information icon image:/images/icon-info.png[information icon] at the top of the page to see a summary of the SpotIQ analysis.
+
image::/images/spotiq-details.png[]
+
...
image::/images/spotiq-expiration.png[]
...
Do this now, click image:/images/icon-ellipses.png[more options menu icon] > *Save*:

image::/images/spotiq-save.png[]
...
+
image::/images/spotiq-outliers.png[]
+
...
+
image::/images/spotiq-correlations.png[]
+
...
In the xref:/spotiq/spotiq-customize.adoc[next section], learn how to schedule SpotIQ to regularly deliver insights.
