...
This procedure shows how to install supported xref:/admin/data-security/about-secure-monitor-sw.adoc[third-party security and monitoring software] on a ThoughtSpot cluster:
