...
. *Configure nodes* Refer to xref:/appliance/aws/installing-aws.adoc[Configure ThoughtSpot nodes in AWS] to configure your nodes.
...
* xref:/appliance/hardware/nodesconfig-example[The nodes.config file]
