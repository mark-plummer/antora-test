...
image::shared:enterprise:charts-bar.png[Bar chart]
...
image::shared:enterprise:charts-stacked-bar-labels.png[Stacked bar chart with labels]
...
image::shared:enterprise:charts-stacked-bar-100.png[Stacked bar chart -- Stack 100 percent toggled on]
