...
+
image::/images/worksheet-edit.png[Edit worksheet]
...
* xref:/admin/data-modeling/about-data-modeling-intro.html[Model the data for searching]
* xref:change-visibility-synonym.html[Hide column or define a column synonym]
