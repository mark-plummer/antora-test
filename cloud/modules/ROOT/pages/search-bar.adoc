...
xref:/end-user/search/about-attributes-and-measures.adoc#measures[Measures] are green, xref:/end-user/search/about-attributes-and-measures.adoc#attributes[attributes] are blue, and xref:/complex-search/about-filters.adoc#[filters] are gray.

image::/images/search-bar-basics.png[Measures, attributes, and filters in the search bar]
