...
Before you apply a filter, make sure xref:/app-integrate/runtime-filters/about-runtime-filters.adoclimitations-of-runtime-filters[understand their limitations].
...
. xref:/app-integrate/JSAPI/enable-JS-API.adoc[Enable the JavaScript API (JS API)] and authenticate to ThoughtSpot.
. Use the xref:/app-integrate/data-api/use-data-api-read.adoc[Data API] or xref:/app-integrate/embedding-viz/embed-a-viz.adoc[Visualization Embedding] to retrieve the answer or pinboard you want to use.
