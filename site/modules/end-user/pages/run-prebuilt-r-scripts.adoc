...
. Click the *R* icon image:/images/r-icon-inline.png[R icon] on the toolbar for any search result (answer).
+
image::/images/r-icon-marketspot.png[]
+
From here, you have options to write a custom script, or load a pre-built or ThoughtSpot provided script.

. In the Analyze dialog, click the ellipses icon image:/images/icon-ellipses.png[more options menu icon] next to the *Custom R Script* panel, and choose *Load*.
+
image::/images/r-load-prebuilt.png[]
+
This brings up a list of pre-built scripts, both provided by ThoughtSpot and any created by programmers on your team.
+
image::/images/r-load-list-of-scripts.png[]
...
image::/images/r-run-time-series-outliers-script.png[]
...
image::/images/r-run-time-forecast-script.png[]
