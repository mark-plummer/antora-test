...
+
image::shared:enterprise:chartconfig-labels-all.png[Check the all labels box]
+
...
+
image::shared:enterprise:chartconfig-reordervalues.png[Select a measure]

. Check the *data labels* box.
+  Note that only the *total sales* data has labels.
+
image::shared:enterprise:chartconfig-datalabels.png[Check the data labels box]
...
+
image::shared:enterprise:chartconfig-labelcategory.png[Specify a label category]
...
+
image::shared:enterprise:chartconfig-decimals.png[Decimal specifications]
