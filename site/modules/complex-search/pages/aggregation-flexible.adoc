adoc= Flexible aggregation functions
...
For more extensive examples of using the `group-aggregate` function, we encourage you to see xref:/reference/practice/reaggregation-scenarios.adoc[Reaggreggation scenarios in practice]
...
* For more examples of flexible aggregation, see the xref:/reference/practice/formula-reference.adocgroup_aggregate[group_aggregate] function in the xref:/reference/formula-reference.adoc[Formula function reference].
...
* To learn about how the `group-aggregate` function can be used within your business practice, we encourage you to see xref:reference/practice/reaggregation-scenarios.adoc[Reaggregation scenarios in practice]
