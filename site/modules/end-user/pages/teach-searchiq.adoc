...
+
image::/images/searchiq_teach.png[]
...
+
image::/images/searchiq_teach_mapper.png[]

. Choose *CONFIRM* to see the new search result.
+
image::/images/searchiq_after_mapping.png[]
...
. Language mappings the user's xref:/admin/users-groups/about-users-groups.adoc[Group members] taught SearchIQ
. xref:/admin/data-modeling/searchiq-mappings.adoc[Language mappings set by the administrator]
...
* xref:/admin/data-modeling/searchiq-mappings.adoc[Modify SearchIQ mappings]
