...
image:/images/smc-haswell-front-view.png[The front of the Haswell appliance]
...
image:/images/smc-haswell-back-view.png[The back of the Haswell appliance]
...
image:/images/smc-skylake-front-view.png[The front of the Skylake appliance]
...
image:/images/smc-skylake-back-view.png[The back of the Skylake appliance]
...
image:/images/smc-serialnumber.png[Location of serial number]
...
Next, xref:/appliance/hardware/connect-appliance-smc.adoc[connect the appliance.]
