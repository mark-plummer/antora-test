...
To repeat user onboarding, see xref:/end-user/introduction/about-user.adoc#onboarding[Revisit onboarding].
...
image:/images/onboard-user-experience-1.png[]
...
+
image::/images/onboard-user-experience-4.png[]
...
As you start to use ThoughtSpot, we recommend that you review xref:/end-user/introduction/getting-started.adoc[Getting Started].
