...
NOTE: Before you set up a reverse tunnel, open port `22` in your firewall outgoing rules to whitelist `tunnelrelay.thoughtspot.com`.
...
. Contact xref:/admin/misc/contact.adoc[ThoughtSpot Support] and open a support ticket for making the appropriate reverse tunnel settings on our end.
...
. Contact xref:/admin/misc/contact.adoc[ThoughtSpot Support] and test your setup.
...
+
image::/images/help_center_support_contact.png[]

* In error messages, when a user selects *What Happened?*
+
image::/images/trace_log.png[Error message support contact]
