...
NOTE: To refresh a materialized view, you must have the xref:/admin/users-groups/about-users-groups.adoc#list-of-privileges[*Can administer ThoughtSpot* privilege].
