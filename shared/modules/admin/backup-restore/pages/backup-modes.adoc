...
ThoughtSpot usually stores backups on a xref:/admin/setup/NAS-mount.adoc[NAS (network attached storage) file system] but you can store them on a local disk as well.
