...
. Click *edit*.
+
image::/images/chartconfig-edityaxis.png[Click edit]
...
image::/images/chart-config-axis-range.gif[Change the axis range gif]
...
image::/images/chart-config-y-axis.gif[Change the axis range gif]
