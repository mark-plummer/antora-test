...
* *xref:/data-integrate/troubleshooting/schema-not-found.adoc[Schema not found error  with ODBC]*
+
...
* *xref:/data-integrate/troubleshooting/how-to-improve-throughput-of-the-load.adoc[How to improve throughput of the load]*
+
The transaction/commit size value can improve the throughput of the load when setting up the ODBC Driver.
* *xref:/data-integrate/troubleshooting/windows-odbc-tracing.adoc[ODBC tracing on Windows]*
+
