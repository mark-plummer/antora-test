...
. Click *Data* in the top menu, and choose *Tables*,  *Worksheets*, or *xref:/complex-search/about-query-on-query.html[Views]*.
...
. Click *Data* in the top menu, and choose *Tables*, *Worksheets*, or *xref:complex-search/about-query-on-query.adoc[Views]*.
. Click the name of your data source.
