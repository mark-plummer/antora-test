...
. xref:/admin/setup/work-with-ts-support.adoc[Configure the connection to the file server].
...
If you do not know the customer name, xref:/admin/misc/contact.adoc[contact ThoughtSpot Support].
