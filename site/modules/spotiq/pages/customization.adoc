...
You access it using the lightbulb button image:/images/icon-lightbulb.png[more options menu icon] or the ellipses menu image:/images/icon-ellipses.png[SpotIQ analyze icon].

image::/images/spotiq-where-customize.png[]
...
image::/images/spotiq-customize-analysis-include.png[]
...
image::/images/spotiq-customize-algorithms.png[]

The *SpotIQ* insights page has an option to open this window to customize a single analysis.

image::/images/spotiq-customize-locations.png[]

The *Tell us more* window provides information on how to exclude a value from all future analysis.

image::/images/spotiq-customize-improve-analysis.png[]

You can set SpotIQ customization parameters in your xref:/_spotiq/spotiq-preferences.adoc[SpotIQ preferences], along with options for email notifications when analyses run.
...
image::/images/spotiq-explain-insight-1.png[]

To explain an insight, do the following:

. Click the ellipses icon image:/images/icon-ellipses.png[more options menu icon] for the insight you want to explain and select *Explain insight*.
...
image::/images/spotiq-explain-insight-2.png[]
