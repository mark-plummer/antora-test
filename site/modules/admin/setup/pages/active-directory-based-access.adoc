...
To enable system AD user access, issue the link:/reference/tscli-command-ref.adoc#tscli-sssd-enable[tscli sssd enable] command:
...
To enable `sudo` permissions for AD group, issue the link:/reference/tscli-command-ref.adoc#tscli-sssd-set-sudo-group[tscli sssd set-sudo-group] command:
...
To clear `sudo` permissions for the AD group, issue the xref:/reference/tscli-command-ref.adoc#tscli-sssd-clear-sudo-group[tscli sssd clear-sudo-group] command:
...
To disable system AD user access, issue the link:/reference/tscli-command-ref.adoc#tscli-sssd-disable[tscli sssd disable] command:
...
* The xref:/reference/tscli-command-ref.adoc#tscli-sssd[sssd command] in the `tscli` command reference
