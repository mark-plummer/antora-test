...
If you want a detailed overview of what SpotIQ does before you try it out, first xref:/spotiq/whatisspotiq.adoc[read the introduction to SpotIQ].
...
. Download the xref:/downloads/FoodDollarDataReal.csv[FoodDollarDataReal] CSV file.
...
. Click the ellipses icon image:/images/icon-ellipses.png[more options menu icon], and select *Upload data*.
...
+
image::/images/spotiq-processing.png[]
...
. Select *Yours*.
+
image::/images/spotiq-insights.png[]
...
At this point, you've created a set of insights using SpotIQ, in the next section you xref:/spotiq/work-with-insights.adoc[Review insights] you created.
