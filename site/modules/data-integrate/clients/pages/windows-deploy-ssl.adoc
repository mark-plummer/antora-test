...
NOTE: The SSL and certificate parameters can be set through the pre-defined options on the options dialog, but customers have reported that these are not always reliable.
...
+
image:/images/windows-odbc-ssl-options.png[]  image:/images/windows-odbc-custom-SSL-property.png[]  image:/images/windows-odbc-custom-SSL-added.png[]
...
+
image:/images/windows-odbc-cert-add-custom.png[]  image:/images/windows-odbc-custom-CACert-property.png[]  image:/images/windows-odbc-cert-and-SSL.png[]
