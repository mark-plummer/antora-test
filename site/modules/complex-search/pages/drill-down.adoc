...
xref:/end-user/pinboards/answer-explorer.adoc[Answer Explorer] provides a flexible, AI-guided exploration of an Answer within a Pinboard.
...
image::/images/drilldown-table.png[Drill down from a data point]
// {% include image.adoc file="drilldown-table.png" title="Drill down from a data point in a table" alt="You can drill down from just one data point, in either table or visualization mode." caption="Drill down from a data point in a table" %}
image::/images/drilldown-chart.png[Drill down from a chart object]
// {% include image.adoc file="drilldown-chart.png" title="Drill down from a data point in a chart" alt="You can drill down from a column in your data, in either table or visualization mode." caption="Drill down from a data point in a chart" %}
...
+
image::/images/drilldown-productfullname.png[Drill down dimensions]
// {% include image.adoc file="drilldown-productfullname.png" title="Drill down dimensions" alt="A list of dimensions, or column names, that you can drill down on appears. Select one to drill down." caption="Drill down dimensions" %}
+
...
+
image::/images/drilldown-example.png[Dairy sales by diet type]
// {% include image.adoc file="drilldown-example.png" title="Dairy sales by diet type" alt="Drill down on the dairy column and select diet type to see a chart showing dairy sales by diet type" caption="Dairy sales by diet type" %}
+
...
To return to the original answer, click the blue reset icon image:/images/icon-drill-down-20px.png[] at the bottom right corner of the Answer.

image::/images/drilldown-pinboard.png[Reset your Answer]
// {% include image.adoc file="drilldown-pinboard.png" title="Reset your Answer" alt="Click the blue reset icon at the bottom right corner of the Answer to return to the original Answer." caption="Reset your Answer" %}

[#explorer-drilldown]
== Drill down with Answer Explorer

You can also drill down using the xref:/end-user/pinboards/answer-explorer.adoc[Answer Explorer] feature.
...
As you drill down on an answer using Answer Explorer, use the back arrow image:/images/icon-arrow-left-20px.png[] to go back one step at a time.
Click the reset icon image:/images/icon-reset-20px.png[] to go back to the original answer.

If you want to go back one step at a time while drilling down, xref:/end-user/pinboards/about-pinboards.adoc#add-an-answer-to-a-pinboard[add your answer to a pinboard] so you can use Answer Explorer.
...
You can also xref:/end-user/pinboards/share-answers.adoc[share the Answer] by clicking the sharing icon image:/images/icon-share copy-20px.png[].
...
See xref:/end-user/data-view/sharing-for-end-users.adoc[overview of sharing] to share your answers, pinboards, or data.
