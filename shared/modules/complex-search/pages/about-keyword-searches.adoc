...
You can access a list of keywords and other reference materials in the xref:/reference/keywords.adoc#[reference] section or in the help.
Open the help by selecting *Help* from the top navigation bar.

image::/images/help_center_keywords.png[]
...
* xref:/reference/keywords.adoc#[Keyword reference]
* xref:/complex-search/search-using-growth-over-time.adoc[Search using growth over time]
* xref:/admin/features/proximity-search.adoc[Geographical proximity keywords "near" and "farther than"]
