...
+
image::/images/growthofkeyword.png[Suggestions for the 'growth of' keyword]
+
...
+
image::/images/growthof-waterfall.png[Growth of total sales by monthly date waterfall chart]
...
+
image::/images/growthof-yearoveryear.png[Growth of sales by monthly year-over-year]
+
...
+
image::/images/growthof-addattribute.png[Growth of sales broken up by department]
...
image::/images/growthof-monthovermonth.png[Growth of sales by date daily month-over-month]
