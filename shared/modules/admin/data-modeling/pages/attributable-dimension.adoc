...
The *Attribution Dimension* setting only applies to tables that join over a xref:/admin/loading/chasm-trap.adoc[Chasm Trap].
...
image::/images/NOT_attribution_dim.png[]
...
image::/images/IS_attribution_dim.png[]
