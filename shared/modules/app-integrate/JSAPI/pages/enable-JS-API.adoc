...
Now, you're ready to either xref:/app-integrate/embedding-viz/embed-a-viz.adoc[embed a visualization] or xref:/app-integrate/data-api/use-data-api-read.adoc[use the REST API to get data] from ThoughtSpot and display it within your Web page or application.
