...
Before you can use the Data REST API, you must authenticate to ThoughtSpot using SAML with the xref:/app-integrate/JSAPI/about-JS-API.adoc[JavaScript API].
...
The procedure for xref:/app-integrate/JSAPI/enable-JS-API.adoc[enabling the JavaScript API] includes information on how to enable this.
...
The xref:/app-integrate/data-api/direct-search-to-embed.adoc[Direct Search-to-Embed API] enables searching directly from an external application or web page to pull data from ThoughtSpot.
...
You can find more information on our public APIs in the xref:/app-integrate/reference/public-api-reference.adoc[Reference guide].

= Related information

* xref:/app-integrate/reference/public-api-reference.adoc[API Reference guide].
* xref:/app-integrate/data-api/direct-search-to-embed.adoc[Direct Search-to-Embed API].
